...
We need more adaptability because before applications weren't changing their achitecture often, they were designed following the Figure~\ref{omodl} schema, this model however didn't permit a lot of optimisations therefore now, to adapt to the demand, application are based on a more horizontal or distributed model as illustrated on Figure~\ref{nmodl}. this cause the architecture of the application to change more often which is the problem will treat in this part.
\end{multicols}
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.65]{./images/PNG/app.png}
\caption{Old model}
\label{omodl}
\end{figure}
...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.59]{./images/PNG/app2.png}
\caption{New model}
\label{nmodl}
\end{figure}
...
By Aubertin Michael and Chanus Baptiste\\
Coordinator Aubertin Michael : maubertin@fr.scc.com
